...
class TwitchLoginButton extends StatelessWidget {
  const TwitchLoginButton({super.key});
  Future<void> _launchURL(BuildContext context) async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const TwitchAuthPage()),
    );
  }
    ...
    return ElevatedButton(
      ...
      child: Row(
        ...
        children: [
          ...
          const Text('Se connecter avec Twitch',
...
class TwitchAuthPage extends StatefulWidget {
  const TwitchAuthPage({super.key});

  @override
  State<TwitchAuthPage> createState() => _TwitchAuthPageState();
}

class _TwitchAuthPageState extends State<TwitchAuthPage> {
  ...
  Future<void> _initialize() async {
    await _makeDemand("api/oauth/twitch");
    setState(() {
      _initializeWebView();
            ...
            if (request.url
              ...
              if (code != null) {
                setState(() {
                  _authCode = code;
                  if (_authCode != "") {
                    _makeRequest(_authCode, "api/oauth/twitch");
